...
![LinearJ main window showing the matrix calculator and netlist workspace](docs/images/linearj-main-window-july-16-2026-NEW.png)

### Adding a circuit component

![LinearJ main window with the add-component dialog open](docs/images/linearj-add-component-dialog-july-16-2026-NEW.png)
